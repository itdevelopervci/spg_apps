...
@IonicPage()
@Component({
  selector: 'page-datangterlambat',
  templateUrl: 'datangterlambat.html',
})
export class DatangterlambatPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad DatangterlambatPage');
  }
  ...
  send_data() {
    ...
    if (this.keterangan == '' || this.keterangan == null) {
      ...
      let body = {
        ...
        aksi: 'insert_presensi_datang_terlambat'
      };
